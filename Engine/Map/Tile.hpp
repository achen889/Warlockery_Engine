...
public:
	...
	const IntVec2& GetMapPosition() const { return m_mapPosition; }
	...
	bool IsVisible() {
		return m_tileState.IsVisible();
	}
	void ResetVisibility() {
		if (IsVisible()) {
			m_tileState.visibility.SetHasBeenSeen(true);
		}
		m_tileState.visibility.SetIsVisible(false);
	}
